...
function Projects() {
  ...
  return (
    ...
    <section className='projects'>
        ...
        <p className='text'> Durante mi formación con el Bootcamp de Adalab, tuve la oportunidad de colaborar en diversos proyectos con mujeres con un talento increible, las cuales me motivaron a seguir aprendiendo y han sido esenciales para mi desarrollo profesional en el ámbito tecnológico. Estos trabajos reflejan mi capacidad de aprendizaje y adaptación a las nuevas tecnologías. Actualmente, me encuentro en una etapa de creación activa, trabajando en el desarrollo de nuevo contenido que espero compartir próximamente. </p>
